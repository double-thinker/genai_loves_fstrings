"""
v4: Validación del campo `links`.

En este ejemplo podemos ver cómo una validación que describa textualmente el
error puede ser suficiente para que la LLM lo corrija en una fase posterior.
"""
